...
export default function ProductDetail({
  ...
  // OK, so this will go ahead and pull out the query strings from our url.
  // Then we can use this to figure out what our style is if we create a constant of styled variant.
  ...
  useEffect(() => {
    ...
    if (recentlyViewed) {
      ...
      if (
        ...
        // ...product is destructed , so it is product.node
      }
    } else {
