...
import clsx from "clsx" //this library is coming with gatsby and its allowing us to apply style conditionally
...
const useStyles = makeStyles(theme => ({
  mainContainer: {
    ...
    width: "100%",
    height: "70rem",
    paddling: "30rem 10rem 10rem 10rem ",
    [theme.breakpoints.down("lg")]: {
      paddling: "20rem 2rem 2rem 2rem ",
    },
            ...
            <IconButton
              ...
              classes={{
                root: clsx(classes.iconButton, {
                  ...
                  // the space class will be applied if its not the selectedSlide and this going to
                  //  be applied   withe iconButton class
                }),
              }}
            >
              <img
