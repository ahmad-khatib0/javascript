...
todo.classList.toggle("done"); //remove
todo.classList.toggle("done"); //add
// So this is generally the better approach to change styles using JavaScript
// which is to use the toggle if you treat with a lot of classes ,and another
// benefit of using toggle is to keep all the styles in css file not in js

// I want to set class to be the current value of it plus the string done.
// todo.setAttribute("class", todo.getAttribute("class") + "done");
// todo.getAttribute("class").includes("done"); // => true or false
