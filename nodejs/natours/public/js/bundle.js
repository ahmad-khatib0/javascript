...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWhtYWQwMDAiLCJhIjoiY2tvY3RwOG1lMDEzMDMxcG9hdndyOWd3byJ9.2c2Bca3w9lRG4STHo0dpsw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/ahmad000/ckocudlan2cym17qnc41va7sh' //   center: [-118.113491, 34.111745],
    //   zoom: 10,
    //   interactive: false,
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'loggen in successfuly ');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error while Loggin out ,,, try again ');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:3000api/v1/users/updateMyPassword' : 'http://127.0.0.1:3000api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.default)('success', "".concat(type.toUpperCase(), " Updated successfuly "));
            }
