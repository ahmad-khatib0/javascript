...
// ╒════════════════════════════════════════════════════════════════════╕
//    The application shell only has to maintain the logic for the root
//    and the first level. Usually, the moment a user selects a link from
//    the home page, we move into a new website area, which represents a
//    new business subdomain, resulting in a micro-frontend being loaded
// ╘════════════════════════════════════════════════════════════════════╛
