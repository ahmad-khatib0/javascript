...
newH2.innerText = "i'm a new element in the page";
const addToSection = document.querySelector("section");
addToSection.appendChild(newH2);
// a child just means anything inside of this section. or show/add this
// element to the section .. notice that this newH2 will goes to the end of this section
