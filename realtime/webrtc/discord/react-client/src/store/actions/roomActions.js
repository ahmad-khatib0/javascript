...
export const getActions = (dispatch) => {
  return {
    setAudioOnly: (onlyAudio) => dispatch(setOnlyAudio(onlyAudio)),
...
export const setLocalStream = (localStream) => {
  return { type: roomActions.SET_LOCAL_STREAM, localStream };
};

export const setOnlyAudio = (audioOnly) => {
  return { type: roomActions.SET_AUDIO_ONLY, audioOnly };
};

export const setRemoteStreams = (remoteStreams) => {
  return { type: roomActions.SET_REMOTE_STREAMS, remoteStreams };
};
